...
window.translations = {
  es: {
    ...
    pi_include_resx1: "INCLUIR ReSx1",
    pi_include_resx2: "INCLUIR ReSx2",
  ...
  en: {
    ...
    pi_include_resx1: "INCLUDE ReSx1",
    pi_include_resx2: "INCLUDE ReSx2",
...
const state = {
  ...
  colDefs: ['dib','be1','be2','gnrh1','gnrh2','pgf1','pgf2','pgf3','ecg','ce','gen','retdib','mo1','mo2','opu','dx1','dx2'],
  ...
  matriz: [
    { name: 'TRADICIONAL(IATF)', days: ['0','0','-','10','-','8','-','-','8','9','10','8','0','8','-','30','60'], hours: Array(17).fill('08:00'), ia: '10', obs: 'IATF 48-60 hs / GnRh Opcional' },
    { name: 'JSYNCH(IATF)', days: ['0','0','-','9','-','6','-','-','6','-','9','6','0','6','-','28','58'], hours: Array(17).fill('08:00'), ia: '9', obs: 'IATF 72 hs + GnRh' },
    { name: 'NOVILLAS(IATF)', days: ['0','0','9','-','-','8','-','-','8','-','10','8','0','8','-','30','60'], hours: Array(17).fill('08:00'), ia: '10', obs: 'IATF 24-32 horas' },
    { name: 'OVSYNCH(IATF)', days: ['-','-','-','0','9','7','-','-','-','-','10','-','0','-','-','30','60'], hours: Array(17).fill('08:00'), ia: '10', obs: 'IATF 12-24 horas post GnRh' },
    { name: 'COSYNCH(IATF)', days: ['-','-','-','0','9','7','-','-','-','-','9','-','0','-','-','30','60'], hours: Array(17).fill('08:00'), ia: '9', obs: 'IATF 48 horas + GnRh' },
    { name: 'HEATSYNCH(IATF)', days: ['-','8','-','0','-','7','-','-','-','-','10','-','0','-','-','30','60'], hours: Array(17).fill('08:00'), ia: '10', obs: 'IATF 48-52 horas post' },
    { name: 'PRESYNCH(IA)', days: ['-','-','-','0','9','-26','-12','0','-','-','10','-','0','-','-','30','60'], hours: Array(17).fill('08:00'), ia: '10', obs: 'Observar celo - IA 12 horas post celo estable' },
    { name: 'SELECTSYNCH(IA)', days: ['-','-','-','0','-','7','-','-','-','-','10','-','0','-','-','30','60'], hours: Array(17).fill('08:00'), ia: '10', obs: 'Observar celo - IA 12 horas post celo estable' },
    { name: 'DIBVACAS(IA)', days: ['0','-','-','0','8','7','-','-','-','-','8','-','0','7','-','28','58'], hours: Array(17).fill('08:00'), ia: '8', obs: 'IA celo detectado + GnRh' },
    { name: 'DIBNOVILLAS(IA)', days: ['0','0','-','8','-','7','-','-','-','-','8','-','0','7','-','28','58'], hours: Array(17).fill('08:00'), ia: '8', obs: 'IA celo detectado + GnRh' },
    { name: 'DOBLEPGF2@(IA)', days: ['-','-','-','-','-','0','11','-','-','-','2','-','0','-','-','20','50'], hours: Array(17).fill('08:00'), ia: '2', obs: 'Observar celo 1-5 días IA 12 horas post celo estable' },
    { name: 'MM1(IA)', days: ['-','-','-','0','-','7','-','-','-','-','9','-','0','-','-','29','59'], hours: Array(17).fill('08:00'), ia: '9', obs: 'IA celo detectado 6 am a 5 pm' },
    { name: 'MM2(IA)', days: ['-','8','-','0','-','7','-','-','-','-','9','-','0','-','-','29','59'], hours: Array(17).fill('08:00'), ia: '9', obs: 'IA celo detectado 6 am a 5 pm' },
    { name: 'MMDIB(IA)', days: ['0','-','-','0','-','7','-','-','-','-','9','8','0','7','-','29','59'], hours: Array(17).fill('08:00'), ia: '9', obs: 'IA celo detectado 6 am a 5 pm' },
    { name: 'REC 1', days: ['0','0','0','-','-','5','-','-','5','-','10','5','0','5','10','18','48'], hours: Array(17).fill('08:00'), ia: '18', obs: 'Transferencia de Embriones' },
    { name: 'REC 2', days: ['0','0','-','-','-','8','-','-','8','9','9','8','0','8','9','17','47'], hours: Array(17).fill('08:00'), ia: '17', obs: 'Transferencia de Embriones' },
    { name: 'RESINCRONIZACION 1 (IATF)', days: ['32','32','-','42','-','40','-','-','40','41','42','40','32','40','-','62','92'], hours: Array(17).fill('08:00'), ia: '42', obs: 'Utilizar DIB de segundo uso - IA 48-60 hs GnRh opcional' },
    { name: 'RESINCRONIZACION 2 (IATF)', days: ['64','64','-','74','-','72','-','-','72','73','73','72','64','72','-','94','124'], hours: Array(17).fill('08:00'), ia: '74', obs: 'Utilizar DIB de segundo uso - IA 48-60 hs GnRh opcional' }
  ],
  activeList: []
};
...
(function autoHeal() {
  try {
    ...
    if (parsed.matriz && Array.isArray(parsed.matriz)) {
       if (parsed.matriz.length > 0 && parsed.matriz[0].days && parsed.matriz[0].days.length !== 17) {
...
function getDIBDivisor() {
  let count = 1;
  if (document.getElementById('pi-check-resx1')?.checked) count++;
  if (document.getElementById('pi-check-resx2')?.checked) count++;
...
function actualizarSelectProtocolos() {
  ...
  // ReSx1 y ReSx2 se mantienen fijos y bloqueados en el HTML según solicitud
  ...
  state.matriz.forEach(p => {
    // Solo mostramos protocolos que no sean de resincronización técnica en la lista general
    if (p.name !== 'REC 1' && p.name !== 'REC 2') {
...
window.calcTableroControl = function() {
  ...
  if (elDuracionL) state.tableroLeche.duracion = parseFloat(elDuracionL.value) || 1;
  ...
  document.getElementById('tc-promedio-leche').innerText = promLeche.toFixed(1);
  ...
  if (elDuracionC) state.tableroCarne.duracion = parseFloat(elDuracionC.value) || 1;
  ...
  if (elPromC) elPromC.innerText = promCarne.toFixed(1);
...
function renderMatriz() {
  ...
  state.matriz.forEach((protocol, rowIdx) => {
    ...
    if (!protocol.days) return;
    protocol.days.forEach((dayVal, colIdx) => {
      // Seguridad: No renderizar más columnas de las que existen en los encabezados
      if (colIdx >= state.colDefs.length) return;
      
      tr.innerHTML += `<td>
        <input type="text" class="cell-input matrix-nav" data-row="${rowIdx}" data-col="${colIdx + 1}" id="matriz-day-${rowIdx}-${colIdx}" value="${dayVal}" 
          ${isMatrixUnlocked ? '' : 'disabled style="border-color:transparent; background:transparent; opacity:1;"'} 
          onchange="updateCell(${rowIdx}, ${colIdx}, this.value, 'days')">
      </td>`;
    });

    // Celdas extra para IA y Observaciones
    tr.innerHTML += `<td>
      <input type="text" class="cell-input matrix-nav" data-row="${rowIdx}" data-col="${state.colDefs.length + 1}" value="${protocol.ia || ''}" ${isMatrixUnlocked ? '' : 'disabled style="border-color:transparent; background:transparent; opacity:1;"'} onchange="updateRowIa(${rowIdx}, this.value, 'ia')">
    </td>`;
    tr.innerHTML += `<td><input type="text" class="cell-input matrix-nav" data-row="${rowIdx}" data-col="${state.colDefs.length + 2}" style="width:200px; text-align:left;" value="${protocol.obs || ''}" ${isMatrixUnlocked ? '' : 'disabled style="border-color:transparent; background:transparent; opacity:1;"'} onchange="updateRowObs(${rowIdx}, this.value)"></td>`;
...
window.restaurarProtocolosBase = function() {
  if(confirm("¿Restaurar protocolos originales de Solugan SG? Se perderán los cambios actuales.")) {
    state.matriz = [
      ...
      { name: 'REC 1', days: ['0','0','0','-','-','5','-','-','5','-','10','5','0','5','10','18','48'], hours: Array(17).fill('08:00'), ia: '18', obs: 'Transferencia de Embriones' },
      { name: 'REC 2', days: ['0','0','-','-','-','8','-','-','8','9','9','8','0','8','9','17','47'], hours: Array(17).fill('08:00'), ia: '17', obs: 'Transferencia de Embriones' },
      { name: 'RESINCRONIZACION 1 (IATF)', days: ['32','32','-','42','-','40','-','-','40','41','42','40','32','40','-','62','92'], hours: Array(17).fill('08:00'), ia: '42', obs: 'DIB día 32. Inseminar día 42.' },
      { name: 'RESINCRONIZACION 2 (IATF)', days: ['64','64','-','74','-','72','-','-','72','73','73','72','64','72','-','94','124'], hours: Array(17).fill('08:00'), ia: '74', obs: 'Re-sincronización tras Dx2. Inseminar día 74.' }
    ];
...
window.updateCell = function(r, c, val, field = 'days') { 
  if (!state.matriz[r][field]) state.matriz[r][field] = Array(16).fill(field === 'days' ? '-' : '08:00');
  state.matriz[r][field][c] = val; 
}
window.updateRowIa = function(r, val, field = 'ia') { 
  state.matriz[r][field] = val; 
}
window.updateRowObs = function(r, val) { state.matriz[r].obs = val; }
...
window.abrirModalPrecios = function(context = 'pi') {
  ...
  categories.forEach(cat => {
    ...
    if (catItems.length > 0) {
      ...
      catItems.forEach(id => {
        ...
        if (dayStr !== '-' && dayStr !== '') {
           ...
           postIaValue = parseInt(dayStr) - iaDay;
        }
              ...
              ${isService ? `
                ...
                ` : `
                  <div class="spinner-wrap" style="width:120px; margin:0 auto;">
                    <button class="spin-btn minus" onclick="spinVal('mod-def-${id}', -0.5, false); recalcFilaModal('${id}', false);">&#8722;</button>
                    <input type="number" step="0.1" id="mod-def-${id}" value="${currentDef}" min="0" class="cell-input" style="text-align:center; padding:5px;" onchange="recalcFilaModal('${id}', false)">
                    <button class="spin-btn plus" onclick="spinVal('mod-def-${id}', 0.5, false); recalcFilaModal('${id}', false);">&#43;</button>
                  </div>`
              }
            </td>
            <td style="text-align: center;">
    ...
    <span class="text-muted" style="font-size:0.75rem; grid-column:2; text-align:left;">${ins.tipo}</span>
            ...
            <td id="mod-lbl-costodosis-${id}" style="text-align: center; color: #f59e0b; font-weight: bold;">${formatter.format(isService ? ins.valorFrasco : (ins.valorFrasco / (ins.tamano || 1) * currentDef))}</td>
          </tr>
        `;
      });
    }
        ...
        if(val > 0) {
           if (['dx1','dx2'].includes(id)) {
              ...
              if (pIaEl) {
                ...
                if (idx !== -1) protocol.days[idx] = (iaDay + postIa).toString();
              }
...
window.toggleProtocolo = function(fase) {
  ...
  const txtSpan = document.getElementById('txt-toggle-' + fase);
  ...
  if (isHidden) {
     ...
     if (txtSpan) txtSpan.innerText = t('btn_hide_p'); // "OCULTAR PROTOCOLO"
     btn.classList.add('active-toggle'); // Rojo
     if (icon) icon.setAttribute('data-lucide', 'eye-off');
  } else {
     // ACCIÓN: VAMOS A OCULTAR
     resDiv.style.display = 'none';
     if (txtSpan) txtSpan.innerText = t('btn_show_p'); // "MOSTRAR PROTOCOLO"
...
window.ejecutarProtocoloInicial = function() {
  ...
  // HITO DE INSEMINACIÓN ARTIFICIAL: Inyectar el evento de IA de manera independiente basado en protocol.ia
  if (protocol.ia !== '' && protocol.ia !== '-') {
    ...
    if (state.insumos['iate']) {
      state.activeList.push({ colId: 'iate', dayOffset: parseInt(protocol.ia), hour: protocol.ia_hour || '16:00' });
    }
  }
  ...
  const txtSpan = document.getElementById('txt-toggle-pi');
  if(txtSpan) txtSpan.innerText = t('btn_hide_p');
...
function actualizarVistaLogo() {
  ...
  const sidebarIcon = document.querySelector('.sidebar-header .logo-icon');
  
  if (state.logoEmpresa) {
    if(container) container.style.display = 'block';
    if(img) img.src = state.logoEmpresa;
    
    // Cambiar el icono de la cabecera por el logo también
    if(sidebarIcon) {
      sidebarIcon.innerHTML = `<img src="${state.logoEmpresa}" style="width: 100%; height: 100%; object-fit: contain; border-radius: 4px;">`;
...
window.loadState = function() {
  ...
  try {
    ...
    if(parsed.matriz && Array.isArray(parsed.matriz)) {
      ...
      // ASEGURAR REC 1 y REC 2 siempre presentes con nombre exacto
      const hasRec1 = state.matriz.find(p => p.name === 'REC 1');
      if (!hasRec1) {
         const oldRec1 = state.matriz.find(p => p.name.includes('REC 1') || p.name.includes('Resincronizacion 1'));
         if (oldRec1) oldRec1.name = 'REC 1';
         else state.matriz.push({ name: 'REC 1', days: ['0','0','0','-','-','5','-','-','5','-','10','5','0','5','10','18','48'], hours: Array(17).fill('08:00'), ia: '18', obs: 'Transferencia de Embriones' });
      }
      const hasRec2 = state.matriz.find(p => p.name === 'REC 2');
      if (!hasRec2) {
         const oldRec2 = state.matriz.find(p => p.name.includes('REC 2') || p.name.includes('Resincronizacion 2'));
         if (oldRec2) oldRec2.name = 'REC 2';
         else state.matriz.push({ name: 'REC 2', days: ['0','0','-','-','-','8','-','-','8','9','9','8','0','8','9','17','47'], hours: Array(17).fill('08:00'), ia: '17', obs: 'Transferencia de Embriones' });
      }
    ...
    if (parsed.logoEmpresa) {
      state.logoEmpresa = parsed.logoEmpresa;
      actualizarVistaLogo();
    }
...
window.ejecutarResx1 = function() {
  const pName = 'REC 1'; // FORZADO FIJO
  ...
  let protocol = state.matriz.find(p => p.name === pName);
  if (!protocol) protocol = state.matriz.find(p => p.name.includes('REC 1') || p.name.includes('Resincronizacion 1'));
  if (!protocol) {
  ...
  if (protocol.ia !== '' && protocol.ia !== '-') {
    ...
    if (state.insumos['iate']) {
      resx1Rows.push({ colId: 'iate', dayOffset: parseInt(protocol.ia), hour: protocol.ia_hour || '16:00' });
    }
  }
  ...
  if(btn) {
    btn.innerHTML = '<i data-lucide="eye-off"></i> OCULTAR PROTOCOLO RESX1';
...
window.ejecutarResx2 = function() {
  const pName = 'REC 2'; // FORZADO FIJO
  ...
  let protocol = state.matriz.find(p => p.name === pName);
  if (!protocol) protocol = state.matriz.find(p => p.name.includes('REC 2'));
  if (!protocol) return;
  ...
  if (protocol.ia !== '' && protocol.ia !== '-') {
    ...
    if (state.insumos['iate']) {
      resx2Rows.push({ colId: 'iate', dayOffset: parseInt(protocol.ia), hour: protocol.ia_hour || '16:00' });
    }
  }
  ...
  const txtSpan = document.getElementById('txt-toggle-resx2');
  if(txtSpan) txtSpan.innerText = t('btn_hide_p');
...
window.syncFases = function() {
  ...
  if (s1) {
    let res1 = state.matriz.find(p => p.name === 'REC 1');
    if (!res1) res1 = state.matriz.find(p => p.name.includes('REC 1'));
    ...
    if (res1) {
      ...
      const firstDay1 = res1.days.find(d => d !== '-' && d !== '') || 0;
      const fReal1 = new Date(fBase);
      fReal1.setDate(fBase.getDate() + (parseInt(firstDay1) || 0));
      if(lblF) lblF.innerText = fReal1.toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' });
    } else if(lblF) {
  ...
  if (s2) {
    let res2 = state.matriz.find(p => p.name === 'REC 2');
    if (!res2) res2 = state.matriz.find(p => p.name.includes('REC 2'));
    ...
    if (res2) {
      ...
      const firstDay2 = res2.days.find(d => d !== '-' && d !== '') || 0;
      const fReal2 = new Date(fBase);
      fReal2.setDate(fBase.getDate() + (parseInt(firstDay2) || 0));
      if(lblF2) lblF2.innerText = fReal2.toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' });
    } else if(lblF2) {
...
window.guardarRegistroInicial = function() {
  ...
  // Guardar en directorio histórico para autocompletado futuro
  ...
  if (idx !== -1) {
    directorio[idx] = perfil;
  } else {
    directorio.push(perfil);
  }
  ...
  setTimeout(() => {
    ...
    console.log("Pantalla de bienvenida oculta.");
  }, 500);
...
function verificarRegistro() {
  ...
  if (perfilStr) {
    ...
    if(sidebarConsultor) {
      sidebarConsultor.innerText = "Usuario: " + perfil.nombre.toUpperCase();
...
window.updateResultados = function() {
  ...
  // 2. COSTOS POR FASE (Excluyendo DIB para evitar duplicidad en la compra total)
  // Calculamos el costo "base" por vaca sin el DIB para sumarlo después
  const dibPrice = state.insumos.dib.valorFrasco || 0;
  const divisorDIB = getDIBDivisor();
  const dibCostApplied = dibPrice / divisorDIB;
  ...
  // Inversión Total = (Costo PI sin DIB * Anim) + (Costo R1 sin DIB * Anim) + (Costo R2 sin DIB * Anim) + (COMPRA TOTAL DIB EN PI)
  // Nota: El footer ya tiene el DIB dividido, así que restamos el DIB dividido y sumamos la compra completa
  const piCostNoDIB = piCostPerAnim - dibCostApplied;
  const r1CostNoDIB = r1CostPerAnim - dibCostApplied;
  const r2CostNoDIB = r2CostPerAnim - dibCostApplied;

  const totalInv = (piCostNoDIB * piAnim) + 
                   (includeR1 ? (r1CostNoDIB * r1Anim) : 0) + 
                   (includeR2 ? (r2CostNoDIB * r2Anim) : 0) + 
                   (dibPrice * piAnim); // Compra única del 100% de dispositivos en PI

  const totalPren = piPren + r1Pren + r2Pren;
  const totalCostPren = totalPren > 0 ? totalInv / totalPren : 0;

  // Totales por fase para la tabla ROI
  const piCost = (piCostNoDIB * piAnim) + (dibPrice * piAnim);
  const r1Cost = includeR1 ? (r1CostNoDIB * r1Anim) : 0;
  const r2Cost = includeR2 ? (r2CostNoDIB * r2Anim) : 0;
  ...
  if(document.getElementById('dash-prot-animal')) document.getElementById('dash-prot-animal').innerText = formatter.format(totalHormonas / (piAnim || 1));
  if(document.getElementById('dash-gen-animal')) document.getElementById('dash-gen-animal').innerText = formatter.format(totalGenetica / (piAnim || 1));
  if(document.getElementById('dash-asis-animal')) document.getElementById('dash-asis-animal').innerText = formatter.format(totalAsistencia / (piAnim || 1));
  if(document.getElementById('dash-iatf-animal')) document.getElementById('dash-iatf-animal').innerText = formatter.format(totalIate / (piAnim || 1));
  // Inversión aplicada por vaca: usa los footers de cada fase (ya incluyen DIB aplicado)
  const numFasesActivas = (piAnim > 0 ? 1 : 0) + (includeR1 && r1Anim > 0 ? 1 : 0) + (includeR2 && r2Anim > 0 ? 1 : 0);
  const invVacaPromedio = numFasesActivas > 0
    ? ((piAnim > 0 ? piCostPerAnim : 0) + (includeR1 && r1Anim > 0 ? r1CostPerAnim : 0) + (includeR2 && r2Anim > 0 ? r2CostPerAnim : 0)) / numFasesActivas
    : 0;
  if(document.getElementById('dash-inv-vaca')) document.getElementById('dash-inv-vaca').innerText = formatter.format(invVacaPromedio);
...
function renderNewDashboardCharts(aPI, pPI, aR1, pR1, aR2, pR2, cHormonas, cGenetica, cAsistencia, cDiagnostico, cIate, cTotal, utilidad, retornoBruto, ingVentaLeche, ingVentaCarne, totalPreneces) {
          ...
          tooltip: {
            callbacks: {
              label: (ctx) => {
                ...
                const porc = anims > 0 ? Math.round((ctx.raw / anims) * 100) : 0;
                return `${ctx.raw} preñeces de ${anims} vacas (${porc}%)`;
              }
            }
          },
          datalabels: {
  ...
  if(ctxCostosH) {
    ...
    // Sort logic to match image style
    const dataObj = [
    ...
    chartCostosH = new Chart(ctxCostosH, {
      ...
      plugins: [typeof ChartDataLabels !== 'undefined' ? ChartDataLabels : null].filter(p => p !== null),
      options: {
        indexAxis: 'y',
        responsive: true,
        maintainAspectRatio: false,
        plugins: {
          legend: { display: false },
          tooltip: { callbacks: { label: (ctx) => formatter.format(ctx.raw) } },
          datalabels: {
            display: true,
            color: '#fff',
            anchor: 'end',
    ...
    chartCarne = new Chart(ctxCarne, {
      ...
      options: {
        ...
        scales: {
          ...
          y: { 
            display: false,
            grace: '20%' // Da espacio arriba para las etiquetas
          }
        }
      }
    });
...
window.exportarExcel = function() {
  ...
  // Título Principal
  data.push(["REPORTE INTEGRAL DE INVERSIÓN - REPROCOST BY SOLUGAN SG"]);
  ...
  ws['!cols'] = [{wch: 25}, {wch: 15}, {wch: 10}, {wch: 35}, {wch: 10}, {wch: 10}, {wch: 20}, {wch: 20}];

  XLSX.utils.book_append_sheet(wb, ws, "Reporte Integral");
  
  // Guardar archivo
  const fileName = `ReproCost_Reporte_Integral_${pName.replace(/\s+/g, '_')}.xlsx`;
...
window.exportarPDF = function() {
  ...
  const opt = {
    ...
    filename:     `ReproCost_Reporte_${pName.replace(/\s+/g, '_')}.pdf`,
  ...
  // Clonar el elemento para evitar problemas con el estado actual
...
window.enviarWhatsApp = function() { 
  ...
  const nit = document.getElementById('pi-nit').value || 'N/A';
  const pais = document.getElementById('pi-pais').value;
  const movil = document.getElementById('pi-movil').value.replace(/\s+/g, '');
  
  const totP = document.getElementById('res-total-preneces').innerText;
  const inv = document.getElementById('res-total-inversion').innerText;
  const cPrenez = document.getElementById('res-costo-prenez').innerText;
  ...
  let msg = isEn ? `*EXECUTIVE SUMMARY - REPROCOST BY SOLUGAN SG*\n\n` : `*RESUMEN EJECUTIVO - REPROCOST BY SOLUGAN SG*\n\n`;
  ...
  msg += `📉 *${isEn ? 'Cost per Pregnancy' : 'Costo por Preñez'}:* ${cPrenez}\n\n`;
  msg += `_Generated automatically by Solugan SG._`;

  const encodedMsg = encodeURIComponent(msg);
  
  let fullNumber = movil;
  if (movil) {
    if (!movil.startsWith(pais)) {
      fullNumber = pais + movil;
    }
  }

  const waUrl = fullNumber ? `https://wa.me/${fullNumber}?text=${encodedMsg}` : `https://wa.me/?text=${encodedMsg}`;
...
window.buscarPorNit = function() {
  ...
  const filtrados = historial.filter(r => r.nit.includes(term));
  ...
  if (filtrados.length > 0) {
    filtrados.forEach((r) => {
      ...
      tr.innerHTML = `
        <td style="font-weight:bold; color:var(--text-muted);">${r.fecha}</td>
        <td>${r.finca}</td>
        ...
        <td style="text-align:center;">
          <button class="btn btn-secondary" onclick="cargarDeHistorial(${r.id})" style="padding: 4px 10px; font-size: 0.75rem; background: rgba(14, 165, 233, 0.1); color: var(--accent); border: 1px solid var(--accent);">
            <i data-lucide="eye" style="width:12px;"></i> CARGAR
          </button>
        </td>
      `;
      tbody.appendChild(tr);
...
try {
  ...
  if(document.getElementById('resx1-protocolo')) document.getElementById('resx1-protocolo').value = 'REC 1';
  if(document.getElementById('resx2-protocolo')) document.getElementById('resx2-protocolo').value = 'REC 2';
